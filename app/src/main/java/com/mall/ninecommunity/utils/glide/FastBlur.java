package com.mall.ninecommunity.utils.glide;
...
public class FastBlur {
    ...
    public static Bitmap blur(Context context, Bitmap sentBitmap, int radius, boolean canReuseInBitmap) {
        if (SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            return rsBlur(context, sentBitmap, radius);
        } else {
            return fastBlur(sentBitmap, radius, canReuseInBitmap);
        }
    }
